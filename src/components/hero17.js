            ...
            {props.content1 ?? (
              <Fragment>
                <span className="hero17-text6">
                  At AltaTech, we specialize in providing cutting-edge AI
                  solutions to help businesses thrive in the digital age. Our
                  team of experts is dedicated to delivering innovative and
                  customized AI services tailored to your specific needs.
                </span>
              </Fragment>
            )}
          </p>
        ...
        <div className="hero17-actions">
          ...
          <button className="thq-button-outline hero17-button2">
            <span className="thq-body-small">
              {props.action2 ?? (
                <Fragment>
                  <span className="hero17-text7">Get in Touch</span>
                </Fragment>
              )}
            </span>
          </button>
