              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text198">$99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text161">$999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing14-list1">
                  ...
                  <div className="pricing14-list-item12">
                    ...
                    <span className="thq-body-small">
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text170">Chatbots</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text197">$199/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text178">$1999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing14-list2">
                  ...
                  <div className="pricing14-list-item15">
                    ...
                    <span className="thq-body-small">
                      {props.plan2Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text204">Chatbots</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  <p className="pricing14-text122 thq-body-large">
                    {props.plan3 ?? (
                      <Fragment>
                        <span className="pricing14-text192">Premium Plan</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text179">$299/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text169">$2999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing14-list3">
                  ...
                  <div className="pricing14-list-item19">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text159">Chatbots</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="pricing14-list-item21">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature5 ?? (
                        <Fragment>
                          <span className="pricing14-text205">Automation</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
            ...
            <div className="pricing14-column4 thq-card">
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text180">$199/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text175">$1999/year</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                  ...
                  <div className="pricing14-list-item23">
                    ...
                    <span className="thq-body-small">
                      {props.plan1Feature21 ?? (
                        <Fragment>
                          <span className="pricing14-text190">Automation</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <button className="pricing14-button17 thq-button-animated thq-button-outline">
                <span className="thq-body-small">
                  {props.plan1Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text155">Upgrade Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column5 thq-card">
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text195">$299/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text203">$2999/year</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                  ...
                  <div className="pricing14-list-item25">
                    ...
                    <span className="thq-body-small">
                      {props.plan2Feature11 ?? (
                        <Fragment>
                          <span className="pricing14-text176">Automation</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <button className="pricing14-button18 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text201">Upgrade Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column6 thq-card">
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text191">$399/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text173">$3999/year</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <button className="pricing14-button19 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text174">Upgrade Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
